...
/**
 * The "How it works" explainer body, shared by the public marketing page and the
 * in-app "How to use" tab (web + mobile). Pass `showCta` to include the sign-in
 * call-to-action (only meaningful when signed out).
 */
