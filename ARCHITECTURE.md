...
Technical reference for how TransferSetu is built, deployed, and operated. For setup/local-dev instructions see [README.md](README.md); this document covers *how the system fits together and runs in production*.
